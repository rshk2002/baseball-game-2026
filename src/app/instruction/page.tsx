        ...
        <div className="mt-3 flex flex-col gap-3 font-mono text-sm">
          <div className="rounded-xl bg-background p-4">
            <p className="text-muted">
              정답이 <b className="text-foreground">678</b>일 때,{" "}
              <b className="text-foreground">689</b>를 내면?
            </p>
            <p className="mt-2">
              <span className="text-strike">6 → 1 STRIKE</span> (숫자·위치 일치)
              {" · "}
              <span className="text-ball">8 → 1 BALL</span> (위치 다름)
              {" · "}
              <span className="text-out">9 → 1 OUT</span>
            </p>
          </div>
          <div className="rounded-xl bg-background p-4">
            <p className="text-muted">
              정답이 <b className="text-foreground">123</b>일 때,{" "}
              <b className="text-foreground">023</b>을 내면?
            </p>
            <p className="mt-2">
              <span className="text-strike">2, 3 → 2 STRIKE</span>
              {" · "}
              <span className="text-out">0 → 1 OUT</span>
            </p>
          </div>
        </div>
      </section>
